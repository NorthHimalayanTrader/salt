        ...
        <div className="flex w-full max-w-7xl flex-col gap-16 overflow-visible md:flex-row md:justify-center md:gap-32 lg:gap-40">
          {cards.map((card, idx) => (
            ...
            >
              ...
              <article className="relative z-20 h-auto min-h-[300px] md:min-h-[620px] rounded-3xl bg-white px-6 pb-10 pt-8 md:px-9 md:pb-14 md:pt-12 text-center shadow-[0_24px_70px_rgba(0,0,0,0.16)]">
